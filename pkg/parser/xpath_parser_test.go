...
func TestNewXPathObject(t *testing.T) {
	suite.Run(t, new(XPathParserArraySuite))
}

type XPathParserArraySuite struct {
	suite.Suite
	body   []byte
	parser parser.Parser
}

func (s *XPathParserArraySuite) SetupTest() {
	...
	s.body = jsonBody
	s.parser = parser.XPathFactory(s.body)
}
